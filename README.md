...
The source code is licensed under the [MIT License](LICENSE). The authoritative legal text is maintained in `LICENSE` at the repository root (not inlined here so updates stay in one place).
